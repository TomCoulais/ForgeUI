 ...
 * @description Contrôleur pour la création d'un utilisateur ou de la connexion.
 * @version 2.0
 * @author COULAIS Tom
 * @date 2025-04-15
 */
...
/**
 * @function loginUser
 * @description Gère la connexion d’un utilisateur et renvoie un token JWT.
 * @param {Object} req - L'objet de requête Express.
 * @param {Object} res - L'objet de réponse Express.
 * @returns {Object} JSON contenant le token ou un message d'erreur.
 */
